...
//         </div>
//         <button className='bg-blue-50 px-3 rounded-lg font-semibold text-blue-600'>{allorders.length} order Dispatched</button>
//       </div>
    ...
    <div className='w-full flex flex-col gap-12 py-12 px-12 bg-gray-50'>
      ...
      <div className='flex justify-between items-center'>
        <div>
          ...
          <p className='text-gray-600 mt-1'>Manage dispatched orders and update delivery status</p>
        </div>
        <button className='bg-blue-100 text-blue-700 px-4 py-2 rounded-lg font-semibold shadow'>
          {allorders.length} Orders Dispatched
        </button>
      </div>
      ...
      <div className='flex flex-col gap-10 items-center'>
        ...
        {allorders.length > 0 ? allorders.map((order, index) => (
          <div key={index} className='flex flex-col bg-green-50 w-full max-w-4xl rounded-xl shadow-md overflow-hidden'>
            ...
            <div className='bg-fuchsia-100 px-6 py-5'>
            ...
            <div className='flex justify-between items-center px-6 py-4 bg-white border-t border-gray-200'>
              <select
                name="status"
                id="status"
                className='border border-gray-300 rounded-md px-4 py-2 text-gray-700 w-40'
          ...
          <div className='flex justify-center text-gray-500 text-lg mt-20'>No Orders Dispatched Yet</div>
        )}
      </div>
    </div>
  );
